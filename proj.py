...
#title of our window
root.title("Weather App - AskPython ft.Afnan.com")
...
def showWeather():
    ...
    api_key = "e074cbe56ebe9774a1312a80ff124043"
...
weather_now = Label(root, text = "The Weather is:", font = 'Calibri 16 bold').pack(pady=10)
 
tfield = Text(root, width=60, height=13)
tfield.pack()
